...
export default connect(commonUtils.mapStateToProps)(commonBase(commonDocEvent(commonBillEvent(commonPurchaseEvent(commonFinanceEvent(OutsideInvoice))))));