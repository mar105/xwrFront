...
const SlaveContainer = (props) => {
  ...
  const columns = [
    ...
    { title: '字段|类型', dataIndex: 'containerType', fieldType: 'varchar', dropType: 'const', viewDrop: '{ "field": "字段", "relevance": "关联性字段", "control": "控件" }', defaultValue: 'field', sortNum: 3, width: 150 },
    ...
    { title: '字段|关联性', dataIndex: 'fieldRelevance', fieldType: 'varchar', dropType: 'const', viewDrop: '{ "varchar": "字符型", "decimal": "数字型", "int": "整型", "smallint": "微整型", "datetime": "日期型", "tinyint": "布尔型", "text": "备注型" }', sortNum: 5, width: 150 },
    ...
    { title: '弹出界面', dataIndex: 'popupActiveName', fieldType: 'varchar', sortNum: 13, width: 150, dropType: 'sql',
    ...
    { title: '查询界面', dataIndex: 'popupSelectName', fieldType: 'varchar', sortNum: 14, width: 150, dropType: 'sql',
      viewDrop: 'Select routeName, id From manRoute Where isDel = 0 and (char_length(routeName) - char_length(REPLACE(routeName, \'/\', \'\'))) >= 2 Order By sortNum ' },
