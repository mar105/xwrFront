...
const SlaveContainer = (props) => {
  ...
  const columns = [
    ...
    { title: '字段|字段类型', dataIndex: 'fieldType', isRequired: true, fieldType: 'varchar', dropType: 'const', viewDrop: '{ "varchar": "字符型", "decimal": "数字型", "int": "整型", "smallint": "微整型", "datetime": "日期型", "tinyint": "布尔型", "text": "备注型" }', isDropEmpty: true, sortNum: 40, width: 150 },
    ...
    { title: '名称|中文', dataIndex: 'chineseName', isRequired: true, fieldType: 'varchar', sortNum: 90, width: 150 },
    { title: '名称|繁体', dataIndex: 'traditionalName', fieldType: 'varchar', sortNum: 100, width: 150 },
    { title: '名称|英文', dataIndex: 'englishName', fieldType: 'varchar', sortNum: 110, width: 150 },
    { title: '是否显示', dataIndex: 'isVisible', fieldType: 'tinyint', sortNum: 120, width: 150 },
    { title: '是否必填', dataIndex: 'isRequired', fieldType: 'tinyint', sortNum: 130, width: 150 },
    { title: '是否求和', dataIndex: 'isSum', fieldType: 'tinyint', sortNum: 140, width: 150 },
    { title: '宽度', dataIndex: 'width', fieldType: 'decimal', sortNum: 150, width: 150 },
    ...
    { title: '下拉|类型', dataIndex: 'dropType', fieldType: 'varchar', dropType: 'const', viewDrop: '{ "sql": "sql语句", "const": "常量", "popupActive": "选择框", "popupSelect": "定位", "popupActiveSelect": "选择框与定位" }', sortNum: 200, width: 150 },
    ...
    { title: '下拉|是否新增', dataIndex: 'isDropAdd', fieldType: 'tinyint', sortNum: 280, width: 150 },
    { title: '下拉|宽度', dataIndex: 'dropWidth', fieldType: 'decimal', sortNum: 290, width: 150 },
    { title: '赋值字段', dataIndex: 'assignField', fieldType: 'varchar', sortNum: 300, width: 150 },
