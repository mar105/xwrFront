...
const SlaveContainer = (props) => {
  ...
  const columns = [
    ...
    { title: '字段名称', dataIndex: 'fieldName', fieldType: 'varchar', sortNum: 3, width: 150 },
    { title: '字段类型', dataIndex: 'fieldType', fieldType: 'varchar', dropType: 'const', dropOptions: '{ "varchar": "字符型", "decimal": "数字型", "int": "整型", "smallint": "微整型", "datetime": "日期型", "tinyint": "布尔型", "text": "备注型" }', sortNum: 4, width: 150 },
    { title: '中文名称', dataIndex: 'chineseName', fieldType: 'varchar', sortNum: 5, width: 150 },
    { title: '繁体名称', dataIndex: 'traditionalName', fieldType: 'varchar', sortNum: 6, width: 150 },
    { title: '英文名称', dataIndex: 'englishName', fieldType: 'varchar', sortNum: 7, width: 150 },
