...
const SlaveContainer = (props) => {
  ...
  const columns = [
    ...
    { title: '名称', dataIndex: 'fieldName', isRequired: true, fieldType: 'varchar', sortNum: 2, width: 150, fixed: 'left' },
    ...
    { title: '字段|字段类型', dataIndex: 'fieldType', isRequired: true, fieldType: 'varchar', dropType: 'const', viewDrop: '{ "varchar": "字符型", "decimal": "数字型", "int": "整型", "smallint": "微整型", "datetime": "日期型", "tinyint": "布尔型", "text": "备注型" }', isDropEmpty: true, sortNum: 4, width: 150 },
    ...
    { title: '名称|中文', dataIndex: 'chineseName', isRequired: true, fieldType: 'varchar', sortNum: 6, width: 150 },
    ...
    { title: '初始状态', dataIndex: 'tagType', fieldType: 'varchar', dropType: 'const', isDropEmpty: true, viewDrop: '{ "alwaysReadonly": "永久只读", "alwaysModify": "永久编辑" }', sortNum: 24, width: 150 },
